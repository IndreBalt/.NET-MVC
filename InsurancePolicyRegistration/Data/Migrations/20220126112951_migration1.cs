    ...
    public partial class migration1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsiurancePolicies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_InsiurancePolicies_AspNetUsers_UserModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsiurancePolicies_UserModelId",
                table: "InsiurancePolicies",
                column: "UserModelId");
        }
